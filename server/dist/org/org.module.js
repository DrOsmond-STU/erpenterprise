...
const org_controller_js_1 = require("./org.controller.js");
...
exports.OrgModule = OrgModule = __decorate([
    (0, common_1.Module)({ imports: [ledger_module_js_1.LedgerModule], controllers: [org_controller_js_1.OrgController], providers: [org_service_js_1.OrgService] })
], OrgModule);
