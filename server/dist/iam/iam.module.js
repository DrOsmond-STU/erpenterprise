...
const iam_controller_js_1 = require("./iam.controller.js");
...
exports.IamModule = IamModule = __decorate([
    (0, common_1.Module)({ controllers: [iam_controller_js_1.IamController], providers: [iam_service_js_1.IamService, settings_service_js_1.SettingsService] })
], IamModule);
