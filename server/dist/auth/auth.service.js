...
let AuthService = class AuthService {
    ...
    async refresh(refreshToken, meta) {
        return this.db.run((0, db_service_js_1.systemContext)(), async (c) => {
            ...
            const s = rows[0];
            if (!s)
                throw new common_1.UnauthorizedException('Sesi tidak dikenal.');
            if (s.revoked_at) {
                ...
                throw new common_1.UnauthorizedException('Sesi dicabut karena token dipakai ulang.');
            }
            if (new Date(s.expires_at) < new Date())
                throw new common_1.UnauthorizedException('Sesi kedaluwarsa.');
            ...
            if (idle > 30 * 60 && idle > this.cfg.ACCESS_TOKEN_TTL_SECONDS) {
                ...
                throw new common_1.UnauthorizedException('Sesi berakhir karena tidak aktif.');
            }
