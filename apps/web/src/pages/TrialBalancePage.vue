...
<template>
  ...
  <article class="card">
    ...
    <div v-else-if="tb && !perBranch" class="table-scroll"><table class="table report">
      <thead>
      ...
      <tbody>
        <template v-for="g in byCat" :key="g.c">
    ...
    <div v-else-if="tb" class="table-scroll"><table class="table report">
